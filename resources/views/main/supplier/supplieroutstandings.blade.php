...
<head>
    ...
    <title>Supplier Outstanding's | Fast Forward</title>
    ...
    @section("content")
        <section>
            <x-breadcrumb :links="[
                ...
                ['url' => '#', 'text' => 'Supplier'],
                ['url' => '/main/supplier/supplieroutstandings', 'text' => 'Supplier Outstandings']
            ]" />

            <!-- Table Start -->
            <div class="shadow-md rounded-lg bg-[#fff]">
                <div class="flex justify-between border-b-[1.5px] border-[#dddddd] px-5 py-3">
                    <h3 class="font-semibold text-2xl">SUPPLIER OUTSTANDING'S</h3>
                    <button type="button" class="inline-flex items-center gap-x-2 text-sm font-medium rounded-full border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
                        <a href="/main/contacts/createsupplier" class="text-[#fff] font-semibold text-sm uppercase py-2 px-5">Create Supplier</a>
                    </button>
                </div>

                <!-- Select Warehouse Start -->
                <div class="grid justify-end mt-5 mb-10 px-5">
                    <div class="w-96">
                                        ...
                                        <div class="hs-dropdown relative inline-flex">
                                            ...
                                            <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-60 bg-white rounded-lg mt-2 divide-y divide-gray-200 dark:bg-neutral-800 dark:border dark:border-neutral-700 dark:divide-neutral-700 shadow-2xl" role="menu" aria-orientation="vertical" aria-labelledby="hs-dropdown-with-icons">
                                                <div class="p-1">
                                                    ...
                                                    <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700" href="/main/contacts/paymentout">
                                                        <img src="/assets/table/wallet-money.svg" alt="" class="w-4 h-4">
                                                        Payment
                                                    </a>
                                                    <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700" href="/main/contacts/creditnotehistory">
                                                        <img src="/assets/table/wallet-money.svg" alt="" class="w-4 h-4">
                                                        Credit Note Entry
                                                    </a>
                                                    <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700" href="/main/contacts/debitnotehistory">
                                                        <img src="/assets/table/wallet-money.svg" alt="" class="w-4 h-4">
                                                        Debit Note Entry
                                                    </a>
                                                    <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700" href="/main/contacts/supplierpaymenthistory">
                                                        <img src="/assets/table/wallet-money.svg" alt="" class="w-4 h-4">
                                                        Payment History
                                                    </a>
