    ...
    @section("content")
        <section>
            ...
            <div class="shadow-md rounded-lg bg-[#fff] dark:bg-gray-800">
                ...
                <div class="py-5 px-5">
                    <form id="" action="{{ route('warehouse.saveOutletToDatabase') }}" enctype="multipart/form-data" method="POST" class="space-y-6">
                        @csrf
                        <!-- Logo Section Start -->
                        ...
                        <div class="col-span-3">
                            ...
                            <select id="warehouse-select" name="warehouse_id" class="py-2.5 sm:py-3 px-4 block w-full border border-gray-400 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                        ...
                        <section class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-5 max-w-4xl">
                            ...
                            <div>
                                ...
                                <input type="text" id="invoice-number-gst" name="invoice_number_gst" class="py-2.5 sm:py-3 px-4 block w-full border border-gray-400 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" required>
                            </div>
                            <div>
                                ...
                                <input type="text" id="invoice-prefix-non-gst" name="invoice_prefix_ngst" class="py-2.5 sm:py-3 px-4 block w-full border border-gray-400 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" required>
                            </div>
                            <div>
                                ...
                                <input type="text" id="invoice-number-non-gst" name="invoice_number_ngst" class="py-2.5 sm:py-3 px-4 block w-full border border-gray-400 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" required>
                            </div>
                        </section>
