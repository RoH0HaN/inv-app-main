...
<head>
    ...
    <title>Create Category | Fast Forward</title>
</head>
<body>
    @extends("main.layout")
        ...
        <section>
         ...
         <!-- For success message -->
            ...
            <div class="shadow-md rounded-lg bg-[#fff] dark:bg-gray-800">
                ...
                <div class="py-5">
                    <form id="" action="{{ route('items.saveCategoryToDatabase') }}" method="POST" class="space-y-6">
                        @csrf
