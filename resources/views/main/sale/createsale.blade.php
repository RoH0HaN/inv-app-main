...
<head>
    ...
    <title>Create Sale | Fast Forward</title>
        ...
        <section>
            ...
            <div class="shadow-md rounded-lg bg-[#fff] dark:bg-gray-800">
                <div class="flex justify-between border-b-[1.5px] border-[#dddddd] px-5 py-3">
                    <h3 class="font-semibold text-2xl">SALE DETAILS</h3>
                </div>
                
                <form id="saleForm" class="space-y-6 py-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-5 px-5">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <button type="button" class="py-[8px] px-4 inline-flex items-center border border-gray-300 rounded-lg transition-all duration-300 hover:bg-gray-50 disabled:pointer-events-none" aria-haspopup="dialog" aria-expanded="false" aria-controls="create-customer-dialog" data-hs-overlay="#create-customer-dialog">
                        ...
                        <div>
                            ...
                            <input type="text" name="invoice_number" class="py-2.5 sm:py-3 px-4 block w-full border border-gray-400 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" required>
                        </div>
                        <div>
                            <label class="block text-base font-semibold mb-2 text-[#8d8d8d] dark:text-white">Sales Code</label>
                            <input type="text" name="sales_code" class="py-2.5 sm:py-3 px-4 block w-full border border-gray-400 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" required>
                        </div>
                        <div>
                        ...
                        <div>
                            <span class="flex gap-3 items-center text-sm mb-2">
                                <p class="font-bold">Advance Balance :</p>
                                <p>10,000,000</p>
                            </span>
                            <label class="block text-base font-semibold mb-2 text-[#8d8d8d] dark:text-white">Adjust Amount</label>
                            <input type="number" name="adjust_amount" step="0.01" class="py-2.5 sm:py-3 px-4 block w-full border border-gray-400 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" value="0.00">
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4 px-5">
                            <div>
                                <label class="block text-base font-semibold mb-2 text-[#8d8d8d] dark:text-white">Sales Note</label>
                                <textarea name="sales-note" class="py-2.5 sm:py-3 px-4 block w-full border border-gray-400 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" rows="2"></textarea>
                            </div>
                            <div>
                                <label class="block text-base font-semibold mb-2 text-[#8d8d8d] dark:text-white">Sales Assistant</label>
                                <select name="sales_assistant" class="py-2.5 sm:py-3 px-4 block w-full border border-gray-400 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" required>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('saleForm').addEventListener('submit', function(e) {
                ...
                const data = {
                    ...
                    sales_code: formData.get('sales_code'),
                    tcs: formData.get('tcs'),
                    adjust_amount: formData.get('adjust_amount'),
                    sales_note: formData.get('sales-note'),
                    sales_assistant: formData.get('sales_assistant'),
                ...
                // Collect items
                document.querySelectorAll('#sale-items-body tr').forEach((row, index) => {
                    data.items.push({
