...
<head>
    ...
    <title>Invoices | Fast Forward</title>
</head>
<body>
    @extends("main.layout")
        ...
        <section>
            ...
            <div class="shadow-md rounded-lg bg-[#fff]">
                <div class="flex justify-between border-b-[1.5px] border-[#dddddd] px-5 py-3">
                    <h3 class="font-semibold text-2xl">INVOICES</h3>
                    <button type="button" class="inline-flex items-center gap-x-2 text-sm font-medium rounded-full border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
                        <a href="/main/sale/createsale" class="text-[#fff] font-semibold text-sm uppercase py-2 px-5">Create Sale</a>
                    </button>
                </div>
                ...
                <section class="grid grid-cols-1 sm:grid-cols-2 gap-5 px-5 py-8">
                    ...
                    <div class="flex items-center justify-between border-l-4 border-[#00a800] px-5 py-4 rounded-xl shadow bg-[#fff]">
                        <div class="grid gap-2">
                            <p class="text-base font-bold tracking-wide text-[#949494]">Tax-inclusive Invoices Amount</p>
                    ...
                    <div class="flex items-center justify-between border-l-4 border-[#FF6600] px-5 py-4 rounded-xl shadow bg-[#fff]">
                        <div class="grid gap-2">
                            <p class="text-base font-bold tracking-wide text-[#949494]">Tax-exempt Invoices Amount</p>
                            <h1 class="text-[#FF6600] font-bold text-xl">1,23,0000.00</h1>
                        </div>
                                        ...
                                        <div class="hs-dropdown relative inline-flex">
                                            ...
                                            <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-60 bg-white rounded-lg mt-2 divide-y divide-gray-200 dark:bg-neutral-800 dark:border dark:border-neutral-700 dark:divide-neutral-700 shadow-2xl" role="menu" aria-orientation="vertical" aria-labelledby="hs-dropdown-with-icons">
                                                <div class="p-1">
                                                    ...
                                                    <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-[#03AD00] hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700" href="/main/sale/completepayment">
                                                        <img src="/assets/main/sale/card-tick.svg" alt="" class="w-4 h-4">
                                                        Complete
                                                    </a>
                                                    <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700" href="#">
                                                        <img src="/assets/main/sale/repeate-music.svg" alt="" class="w-4 h-4">
                                                        Return
                                                    </a>
