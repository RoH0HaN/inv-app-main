...
<head>
    ...
    <title>Create Payment Option | Fast Forward</title>
</head>
<body>
    @extends("main.layout")
           ...
           <!-- For success message -->
            ...
            <div class="shadow-md rounded-lg bg-[#fff] dark:bg-gray-800">
                <div class="flex justify-between border-b-[1.5px] border-[#dddddd] px-5 py-3">
                    <h3 class="font-semibold text-2xl">PAYMENT OPTION DETAILS</h3>
                </div>
                <div class="py-5">
                    <form id="" action="{{ route('settings.savePaymentOptionToDatabase') }}" method="post"  class="space-y-6">
                        @csrf
