...
<body>
    ...
    @section("content")
        <section>
            ...
            <x-edit-dialogs.bank-account-details-edit-component />
        </section>
    @endsection
