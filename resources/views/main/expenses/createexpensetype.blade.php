...
<head>
    ...
    <title>Create Expense Type | Fast Forward</title>
</head>
<body>
    @extends("main.layout")
    ...
    @section("content")
        <section>
            <x-breadcrumb :links="[
                ...
                ['url' => '#', 'text' => 'Expenses'],
                ['url' => route('expenses.expenseType'), 'text' => 'Expense Type List'],
                ['url' => route('expenses.createExpenseType'), 'text' => 'Create Expense Type']
            ]" />
            ...
            <div class="shadow-md rounded-lg bg-[#fff] dark:bg-gray-800">
                <div class="flex justify-between border-b-[1.5px] border-[#dddddd] px-5 py-3">
                    <h3 class="font-semibold text-2xl">EXPENSE TYPE DETAILS</h3>
                </div>
                <div class="py-5">
                    <form id="" action="{{ route('expenses.saveExpenseTypeToDatabase') }}" method="POST" class="space-y-6">
                        @csrf
                        <div class="grid gap-y-5 px-5">
                            <div>
                                ...
                                <input type="text" name="name" id="name" class="py-2.5 sm:py-3 px-4 block w-full border border-gray-400 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" required>
                            </div>
                            <div>
