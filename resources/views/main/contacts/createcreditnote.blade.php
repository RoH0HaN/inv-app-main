    ...
    @section("content")
        <section>
            <x-breadcrumb :links="[
                ...
                ['url' => {{ route('contacts.createCreditNote') }}, 'text' => 'Credit Note Entry']
            ]" />

            <div class="shadow-md rounded-lg bg-[#fff] dark:bg-gray-800">
                <div class="flex justify-between border-b-[1.5px] border-[#dddddd] px-5 py-3">
                    <h3 class="font-semibold text-2xl">CREDIT NOTE DETAILS</h3>
                </div>
                <div class="py-5">
                    <form id="supplierForm" action="#" class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-5 px-5">
                            ...
                            <div>
                                <label class="block text-sm font-semibold mb-2 text-[#8d8d8d] dark:text-white">Credit Note Type</label>
                                <select id="credit-note-type" class="py-2.5 sm:py-3 px-4 pe-9 block w-full border border-gray-400 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                                    <option value="">Select Credit Note</option>
                                    <option value="Price Drop CN">Price Drop CN</option>
                                    <option value="Sale Out CN">Sale Out CN</option>
                                </select>
                            </div>
                        </div>
