...
<head>
    ...
    <title>Report By Item Customer | Fast Forward</title>
        ...
        <section>
            ...
            <div class="shadow-md rounded-lg bg-[#fff]">
                <div class="flex justify-between border-b-[1.5px] border-[#dddddd] px-5 py-3">
                    <h3 class="font-semibold text-2xl">REPORT BY ITEM</h3>
                </div>
                ...
                <section class="grid grid-cols-4 items-center px-5 py-3 gap-10">
                    ...
                    <div>
                        ...
                        <select id="customerSelect" class="py-2.5 sm:py-3 px-4 pe-9 block w-full border border-gray-400 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
