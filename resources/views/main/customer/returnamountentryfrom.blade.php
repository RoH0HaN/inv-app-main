...
<head>
    ...
    <title>Return Amount Entry | Fast Forward</title>
    ...
    @section("content")
        <section>
            <x-breadcrumb :links="[
                ...
                ['url' => route('customer.returnAmountHistory', $selectedCustomerId), 'text' => 'Return Amount History'],
            ...
            <div class="shadow-md rounded-lg bg-[#fff] dark:bg-gray-800">
                <div class="flex justify-between border-b-[1.5px] border-[#dddddd] px-5 py-3">
                    <h3 class="font-semibold text-2xl">RETURN AMOUNT DETAILS</h3>
                </div>
                <div class="py-5">
                    <form id="supplierForm" action="{{ route('customer.saveReturnAmountEntryToDatabase') }}" method="POST" class="space-y-6">
                        @csrf
