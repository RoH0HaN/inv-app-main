                ...
                <div class="py-5 px-5">
                    <form id="" action="#" class="space-y-6">
                        ...
                        <div class="flex gap-10">
                            <img src="/assets/users/demo_profile.png" alt="" class="rounded w-32 h-32 aspect-square object-cover object-center" />
                            <div>
                        ...
                        <section class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-5">
                            ...
                            <div>
                                ...
                                <select id="role" class="py-2.5 sm:py-3 px-4 pe-9 block w-full border border-gray-400 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                            ...
                            <div>
                                ...
                                <select id="status" class="py-2.5 sm:py-3 px-4 pe-9 block w-full border border-gray-400 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
