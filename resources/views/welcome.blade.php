...
<head>
    ...
    <title>Sing In | Fast Forward</title>
</head>
<body class="min-h-screen grid place-items-center">
    <div class="mt-7 bg-white border border-gray-200 rounded-xl shadow-2xs dark:bg-neutral-900 dark:border-neutral-700 w-[60rem]">
  <div class="p-4 sm:p-7">
    ...
    <div class="mt-8 grid grid-cols-2">
      <div class="rounded-l-lg w-full h-full overflow-hidden">
